...
// a
// document.getElementById('tp').model = { markup: 'leave_type' }, users };
// alert(datafrom);
// var gd = document.getElementById('tp');
// gd.model = 
// {
//   userslist: users
// }
...
{
  this.daylist = new Array('SUN','MON','TUE','WED','THR','FRI','SAT','SUN','MON','TUE','WED','THR','FRI','SAT'); /*<lang:en>*/
...
function change(){
//   // document.getElementById("user_leave.objects.leave_type")
//   <p id="demo"></p>
//   for a in user_leave.objects.all()
// document.getElementById("demo").innerHTML =
// a.leave_type + " is " + a.From_date + " years old.";
